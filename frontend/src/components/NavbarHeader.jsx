...
const NavbarHeader = (props) => {
    ...
    return (
               <header className=" bg-nav  w-100 ">
                <div className="flex justify-between ">
                    <div className="p-1 mx-3 inline-flex items-center">
                       <FontAwesomeIcon onClick={props.sidebarToggle}  icon={faBars} className="h-5 w-5 ml-1 text-blue-500 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white dark:text-gray-400" />
                        ...
                        <Link to="/" className="flex items-center pl-2.5 mb-2">
                            ...
                            */}
                                <div   className= "text-gradient-white  mt-2" >
                                    <span className="mx-0 p-0 mt-0 ml-0">MIND MATTERS</span>
                                </div>
                            {/*
