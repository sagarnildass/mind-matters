...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-50 h-full transition-transform ${isOpen ? 'w-64' : 'w-0'} md:w-40 sm:w-10 overflow-x-hidden`} aria-label="Sidebar">
